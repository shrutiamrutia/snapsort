                    ...
                    <div id="root">
                        <div class="container">
                            <div>
                                ...
                                <nav class="main-nav">
                                    <ul>
                                        <li><a href="/mountain" aria-current="page" class="active" onClick={this.mountainLoginPage}>Mountain</a></li>
                            ...
                            <div>
                                ...
                                <div class="photo-container">
                                    <div>
                                        <ul>
                                            <Gallery data={this.state.imageList} />
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
const mapDispatchToProps = dispatch => {
    return {
        onMountainLogin: (data) => dispatch(actions.mountainLogin(data)),
    }
}


export default connect(null, mapDispatchToProps)(Mountain);
